	...
	if state['ext_type'] == cwiid.EXT_NONE:
		...
		if 'classic' in state:
			print('Classic: btns=%.4X l_stick=%r r_stick=%r l=%d r=%d' % (
				...
				state['classic']['l_stick'],
				state['classic']['r_stick'],
				state['classic']['l'],
				state['classic']['r'],
				))
		...
		if 'balance' in state:
			print('Balance: right_top=%d right_bottom=%d left_top=%d left_bottom=%d' % (
				state['balance']['right_top'],
				state['balance']['right_bottom'],
				state['balance']['left_top'],
				state['balance']['left_bottom'],
				))
